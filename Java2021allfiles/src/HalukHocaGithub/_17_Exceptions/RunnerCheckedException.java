...
public class RunnerCheckedException {
	...
	public static void mailDogrula(String email) throws _17_Exceptions.InvalidEmailIdCheckedException {
		
		if (email.contains("@gmail.com") || email.contains("@ebıkgabık.com")) {
			System.out.println("gayet basarili....");
			
		}else{
			throw new _17_Exceptions.InvalidEmailIdCheckedException("neyin kafasi bu. ne ictiysen bana da ....");
