package _98_Projects.VarmisinYokmusun;
...
/*
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        HashMap <String, Integer> kutular = new HashMap<>();
        ...
        System.out.println("Lutfen kendi kutunuzu seciniz: ");
        ...
        if (!kutular.containsKey(secim)) {
            ...
            System.out.println("Lutfen yalnizca mevcut kutulardan secim yapiniz!");
        } else {
            ...
            kutular.put("Yarismacinin Kutusu", yarismaciKutusu);
    ...
    private static void kutuSec(HashMap<String, Integer> kutular) throws InterruptedException {
    ...
    private static int teklifVer(HashMap<String, Integer> kutular) {
        ...
        for (Map.Entry<String, Integer> w : kutular.entrySet()) {
