package HalukHocaGithub._21_Set;
...
public class Ex05 {
	...
	public static int[] tekrarlariSil(int[] arr) {
		...
		Set<Integer> set1 = new HashSet<>();//Set Hashset'in parent'i olduğu için HasHSet metodlarını kullanamaz ama daha hızlı çalışır. SEt interface oldğ için obj oluşturulamaz HashSet Class olduğu için new ile obj oluşturduk.
